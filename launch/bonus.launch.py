...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'thymio_name',
            default_value='thymio_0'
        ),
        DeclareLaunchArgument(
            'thymio1_name',
            default_value='thymio_1'
        ),
        DeclareLaunchArgument(
            'thymio2_name',
            default_value='thymio_2'
        ),
        DeclareLaunchArgument(
            'thymio3_name',
            default_value='thymio_3'
        ),
        ...
        Node(
            ...
            # relative topic names in controller_node, this provides a nice way
            # to specify which robot this node should control.
            namespace=LaunchConfiguration('thymio1_name'),
        ...
        Node(
            ...
            # relative topic names in controller_node, this provides a nice way
            # to specify which robot this node should control.
            namespace=LaunchConfiguration('thymio2_name'),
        ...
        Node(
            ...
            # relative topic names in controller_node, this provides a nice way
            # to specify which robot this node should control.
            namespace=LaunchConfiguration('thymio3_name'),
